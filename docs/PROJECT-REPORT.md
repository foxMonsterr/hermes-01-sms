...
| # | 表名 | 版本 | 字段数 | 说明 |
|---|---|---|---|---|
| 1 | sys_user | v1.0 | 8 | 用户表 (v5.0 +avatar_url) |
| 2 | snack_category | v1.0 | 7 | 分类表 |
| 3 | snack | v1.0 | 13 | 零食表 (v4.0 +price/image_url) |
| 4 | stock_record | v4.0 | 8 | 库存流水表 |
| 5 | shopping_list | v4.0 | 15 | 采购清单表 (v5.0 +supplier字段) |
| 6 | notification | v4.0 | 8 | 消息提醒表 |
| 7 | system_config | v5.0 | 5 | 系统配置表 |
| 8 | disposal_record | v5.0 | 10 | 过期/丢弃记录表 |
| 9 | inventory_check_record | v5.0 | 9 | 库存盘点记录表 |
| 10 | supplier | v5.0 | 9 | 供应商表 |
| 11 | operation_log | v5.0 | 9 | 操作日志表 |
...
| /suppliers | SupplierListView | 供应商 CRUD + 采购统计弹窗 (v5.0) |
| /logs | OperationLogView | 操作日志多维度筛选 (v5.0) |
| /settings | SettingsView | 4 Tab: 个人资料/修改密码/系统偏好/数据维护 (v5.0) |
| * | NotFoundView | 404 页面 |
...
> 项目完整路径: `C:\Users\Administrator\snack-manager\`
>
> 生成时间: 2026-05-23
