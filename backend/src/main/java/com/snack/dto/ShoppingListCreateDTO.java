...
@Schema(description = "采购清单创建请求")
public class ShoppingListCreateDTO {

    @Schema(description = "关联零食ID（可选）")
    ...
    @Schema(description = "分类ID（可选，需属于当前用户）")
    private Long categoryId;

    @Min(1)
    @Schema(description = "计划采购数量", example = "3")
    private Integer plannedQty = 1;

    @Schema(description = "预估单价", example = "5.50")
